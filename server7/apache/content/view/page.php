<?php
$themeStyleSheet = 'http://localhost:8081/view/css/light_theme.css';
if (!empty($_COOKIE['theme']) && $_COOKIE['theme'] == 'dark') {
    $themeStyleSheet = 'http://localhost:8081/view/css/dark_theme.css';
}
...
<script>
    ...
    if (currentTheme === "dark") {
        STYLESHEET_LINK.href = "http://localhost:8081/view/css/dark_theme.css"
    } else {
        STYLESHEET_LINK.href = "http://localhost:8081/view/css/light_theme.css"
    }
